/*
 * User: Jonathan Slenders and Christophe Lambrechts
 * Date: 25/04/2006
 */

using System;
using System.Collections; // voor ArrayList
...
{
	/// <summary>
	/// Test class that has a Main() method where
	/// object of the TryCode class can be tested
	/// </summary>
	class MainChristophe
	{
		...
		static void Main(string[] args)
		{
			...
			Type t = typeof(Yaml.Binary);
			string s = t.Assembly.FullName.ToString();
			Console.WriteLine("The fully qualified assembly name of Yaml is {0}.", s);
		...
		static private void testYamlNode()
		{
			...
			// Parse all items in ArrayList, catches ParseException
		...
		private static void Varia(ArrayList parse)
		{
			parse.Add("- \"test\"");
		}

		private static void Float(ArrayList parse)
		{
			parse.Add("!!float -.inf"); 
			parse.Add("+.inf");
			parse.Add("+.Inf");
		...
		private static void Timestamp(ArrayList parse)
		{
			...
			parse.Add("!!timestamp 2001-12-15		24:59:43"); //something wrong with 24 hour, can not! For the spec this is right
		...
		private static void Binary(ArrayList parse)
		{
		...
		private static void Null(ArrayList parse)
		{
			parse.Add("");
			parse.Add("~");
			parse.Add("null");
		...
		private static void Boolean(ArrayList parse)
		{
			parse.Add("y");
			parse.Add("Y");
			parse.Add("yes");
		...
		private static void Integer(ArrayList parse)
		{
			...
			parse.Add("!!int 9223372036854775808"); //To large, force in int (gives error)
			parse.Add("2147483647"); //Max value int32
		}

		private static void String(ArrayList parse)
		{
			parse.Add("Test \"te");
			parse.Add("!!str | \n abc \n def");
